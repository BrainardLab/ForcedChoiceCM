function ForcedChoiceCMLocalHook
% ForcedChoiceCMLocalHook
%
% Configure things for working on the ForcedChoiceCM project.
%
...
setpref(projectName,'rayleighDataDir',fullfile(baseDir,'MELA_data','Experiments',projectName));
