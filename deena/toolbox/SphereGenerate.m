function x = SphereGenerate(nTheta,nPhi,rho)
% x = SphereGenerate(nTheta,nPhi,rho)
%
...
%   rho    - Distance from the center to each point
%
...
% 
% 7/30/2020  dce Adapted from UnitSphereGenerate 

% Generate a sphere in 3D
