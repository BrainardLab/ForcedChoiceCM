...
%                       false.
%    'predicted'       -Logical indicating to return predicted OL spectra 
%                       instead of nominal spectra. Default is true.
...
p.addParameter('predicted',true,@(x)(islogical(x)));
