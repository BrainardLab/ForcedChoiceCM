...
[~,~,~,~,~,~,recoveredStaircaseParams]...
    ...
    'LMEqualOD',false,'dlens0',true,'dmac0',true,'S0',true,'lambdaMax0',...
    false,'OD0',false,'restrictBySd',true,'makeNoObserverPlots',true,...
    'sampledObservers',sampledConeParams,'lambdaRef',p.Results.lambdaRef,...
