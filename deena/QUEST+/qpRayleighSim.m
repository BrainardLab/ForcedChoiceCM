...
for ii = 1:nObservers
    ...
    psiParamsFit(ii,:) = qpFit(questData{ii}.trialData,questData{ii}.qpPF,...
        ...
        domainVlb,'upperBounds',domainVub,'display','iter');
...
if p.Results.plotAll || p.Results.plotLast
    ...
    set(paramsPlot,'Color',[1 1 1],'Position',[10 10 1700 900]);
    hold on;
    nCols2 = 2;
    nRows2 = 2;
    ...
    NicePlot.exportFigToPDF(fullfile(data9.outputDir,[data9.subjID '_'....
        num2str(data9.sessionNum) '_paramsPlot.pdf']),...
        paramsPlot,300);
