%% To run once
% Subject information 
subjID = 'MELC_0005';  % Correct as needed (MELA ID)
age = 30;         % Correct as needed
...
%% Session 1 
% First ref wavelength - done 7/13
trialSessionNum = 11;  
...
% Second ref wavelength - done 7/13
trialSessionNum = 12;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Third ref wavelength - done 7/13
trialSessionNum = 13;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Fourth ref wavelength - done 7/13
trialSessionNum = 14;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Sixth ref wavelength - done 7/13
trialSessionNum = 16;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Second ref wavelength - done 7/14
trialSessionNum = 22;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Third ref wavelength - done 7/14
trialSessionNum = 23;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Fourth ref wavelength - done 7/14
trialSessionNum = 24;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
...
% Sixth ref wavelength - done 7/14
trialSessionNum = 26;  
[trialFNames, ~, ~] = getMatchSeriesLive(subjID,trialSessionNum,settings.p1,...
