...
for i = 1:nCombos
    ...
    OLRayleighMatch([subjID '_' num2str(sessionNum)],i,'simObserver',false,'fieldSize',...
        ...
        adjustmentLength,'opponentParams',...
    ...
    save(outputFile,'fNames','testIntensities','primaryRatios','lightCombosFull',...
        ...
        'interleaveStaircases');
end
% Reshape data arrays to row vectors
testIntensities = reshape(testIntensities,[1 numel(testIntensities)]);
primaryRatios = reshape(primaryRatios,[1 numel(primaryRatios)]);
save(outputFile,'fNames','testIntensities','primaryRatios','lightCombosFull',...
    'age','fieldSize','opponentParams','p1Scale','p2Scale','testScale',...
    'adjustmentLength','adjustment','nObserverMatches','testWls','interleaveStaircases');
end